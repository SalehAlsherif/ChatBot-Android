...
class ChatArrayAdapter extends ArrayAdapter<ChatMessage> {
   ...
   /* public int getItemType(int index) {
        ChatMessage item = getItem(index);
        if (item.isMine())
            return MY_MESSAGE;
        else
    ...
    /*public View getVieww(int position, View convertView, ViewGroup parent) {
        ...
        if (chatMessageObj.isMine){
            row = inflater.inflate(R.layout.sent_msg, parent, false);
            chatText = (TextView) row.findViewById(R.id.sent_msg);
            chatText.setText(chatMessageObj.message);
        }
        else{
            row = inflater.inflate(R.layout.recieved_msg, parent, false);
            chatText = (TextView) row.findViewById(R.id.recieved_msg);
            chatText.setText(chatMessageObj.message);
        }
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (viewType==3 ) {
            ...
            nocorrect.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                    ...
                    JSONObject jsn=new JSONObject();
                    try {
                        jsn.put("message","no,correct this");
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    MainActivity cont = (MainActivity) context;
        ...
        if(viewType==6){
            ...
            start_again.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View arg0) {
                 ...
                 //   cont.chatList=(ListView) LayoutInflater.from(getContext()).inflate(R.layout.results, parent, false).findViewById(R.id.chatlist);
                  //  chatList.setListAdapter(new List<ChatMessage>);
      ...
      /*  convertView.findViewById(R.id.recieved_msg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(), "onClick", Toast.LENGTH_LONG).show(); //test
            }
        });*/
        return convertView;
    }
